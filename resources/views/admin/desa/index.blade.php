            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown ">
                        ...
                        <ul class="sub-menu children dropdown-menu">                            
                            <li><i class="fa fa-tags"></i><a href="{{url('admin/pengumuman')}}">Tampilkan</a></li>
                            <li><i class="fa fa-pencil-square-o"></i><a href="{{url('admin/pengumuman/create')}}">Buat tentang desa</a></li>
                        </ul>
                    </li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <strong class="card-title">Semua Tentang Desa</strong>
                            </div>
                            <div class="table-stats order-table ov-h">
                                <table class="table">
                                    ...
                                    <tbody>
                                        @foreach($tentangdesas as $pengumuman)
                                        <tr>
