                        ...
                        <div class="card">
                            <div class="col-md-6 offset-3"><br>
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal" action="{{ route('masyarakat-update', $user->id) }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                        @method('POST')
                                 ...
                                 <div class="card">
                                    <div class="card-body">
                                        ...
                                        <input type="text" name="named" autocomplete="off" value="{{$user->name}}" class="form-control">
                                    </div>
                                     <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="numeber" name="telp" autocomplete="off"  value="{{$user->telp}}" class="form-control bg-white">
                                    </div> --}}
