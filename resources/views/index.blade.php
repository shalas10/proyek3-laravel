                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-1">
                            <div class="logo">
                                <a href="{{url('/')}}"><img src="assets/img/logo/Logo2.png" alt="" width="40"></a>
                            </div>
                        </div>
                            ...
                            <div class="main-menu f-left d-none d-lg-block">
                                <nav> 
                                    <ul id="navigation">    
                                        ...
                                        <li><a href="{{url('about')}}">About Appemas</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="row d-flex align-items-center">
                            <div class="col-lg-7 col-md-9 ">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInLeft" data-delay=".4s">Pengaduan Masyarakat</h1>
                                    <p data-animation="fadeInLeft" data-delay=".6s">Sampaikan laporan Anda langsung kepada Desa Lelea Melalu APPEMAS, Anda bisa langsung terhubung dengan Desa Lelea.</p>
                                    <!-- Hero-btn -->
                                    @guest
                            ...
                            <div class="col-lg-5">
                                <div class="hero__img d-none d-lg-block" data-animation="fadeInRight" data-delay="1s">
                                    <img src="assets/img/hero/hero_right1.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row ">
                    <div class="col-lg-3 col-md-4">
                        <div class="single-visited mb-30">
                            ...
                            <div class="visited-cap">
                                <h3><a href="https://bogorkab.go.id/" target="_blank">Indramayu.go</a></h3>
                                <p>Portal Kabupaten Indramayu</p>
                            </div>
                        </div>
                    </div> 
                     <div class="col-lg-3 col-md-4">
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="single-visited mb-30">
                            ...
                            <div class="visited-cap">
                                <h3><a href="https://kotabogor.go.id/" target="_blank">Desa Lelea.go</a></h3>
                                <p>Desa Lelea</p>
                            </div>
                        </div>
                    </div> 
