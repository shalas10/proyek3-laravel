...
//TENTANG DESA
// PENGUMUMAN
Route::resource('admin/tentangdesa', 'TentangDesaController')->middleware('admin');
Route::get('admin/tentangdesa/{id}/show/', 'TentangDesaController@showing')->name('tentangdesa.showing')->middleware('admin');
...
// // PENGADUAN - TANGGAPAN
Route::get('petugas/pengaduan', 'PetugasPengaduanController@index')->name('petugas-tanggapan.index')->middleware('petugas');
...
Route::post('petugas/pengaduan/{id}/update','PetugasPengaduanController@update')->name('pengaduan-petugas.update')->middleware('petugas');
// PDF LAPORAN CETAK
Route::get('petugas/laporan', 'LaporanController@petugaslaporan')->middleware('petugas');
Route::get('pengaduan_pdf/cetak_pdf', 'LaporanController@cetak_pdf')->name('cetak-laporan');
// // KOMENTAR
